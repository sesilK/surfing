...
<body>
	...
	<div class="container">
		<div class="topnav" style="position: absolute; z-index: 2">
			<a href="home.jsp" style="position: absolute; right: 360px;"><img
				src="images/whitelogo.png" style="width: 100px; height: 100px"></a>
			<ul>
				<%
				if (id == null) {
				%>
				<li class="nav-item"><a href="member.jsp"
					style="position: absolute; left: 380px;"><img
						src="images/whitelogin.png"></a></li>
				<%
				} else {
				%>
				<li class="nav-item"><a href="signout_proc.jsp"
					style="position: absolute; left: 380px;"><img
						src="images/whitelogout.png"></a></li>
				<%
				}
				%>
			</ul>
